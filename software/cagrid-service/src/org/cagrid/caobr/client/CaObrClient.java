...
public class CaObrClient extends CaObrClientBase implements CaObrI {	
  ...
  public edu.wustl.caobr.Annotation[] getAllAnnoations(java.lang.String token) throws RemoteException {
    synchronized(portTypeMutex){
      configureStubSecurity((Stub)portType,"getAllAnnoations");
    org.cagrid.caobr.stubs.GetAllAnnoationsRequest params = new org.cagrid.caobr.stubs.GetAllAnnoationsRequest();
    params.setToken(token);
    org.cagrid.caobr.stubs.GetAllAnnoationsResponse boxedResult = portType.getAllAnnoations(params);
