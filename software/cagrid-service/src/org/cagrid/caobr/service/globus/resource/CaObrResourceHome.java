 ...
 * 
 */
public class CaObrResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(CaObrResourceHome.class);
	...
	public Resource find(ResourceKey key) throws ResourceException {
		CaObrResource resource = (CaObrResource) super.find(key);
		return resource;
	}
     ...
     */
    public CaObrResource getAddressedResource() throws Exception {
        CaObrResource thisResource;
        thisResource = (CaObrResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
}